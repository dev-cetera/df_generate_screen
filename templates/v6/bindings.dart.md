...
abstract base class _ControllerBroker<T1 extends ___CLASS___, T2 extends _State>
  ...
  late final configuration = screen.extra is ___CONFIGURATION_CLASS___
      ? screen.extra as ___CONFIGURATION_CLASS___
      : ___CONFIGURATION_CLASS___.optional(
...
typedef T___CLASS___Controller =  _ControllerBroker<___CLASS___, _State>;

/// A [AdaptiveScreenState] type corresponding to [___CLASS___].
typedef TAdaptive___CLASS___State = AdaptiveScreenState<___CLASS___, ___CONFIGURATION_CLASS___, ___CLASS___Controller>;

/// A [ScreenState] type corresponding to [___CLASS___].
typedef T___CLASS___State = ScreenState<___CLASS___, ___CONFIGURATION_CLASS___, ___CLASS___Controller>;

/// A [ScreenPageState] type corresponding to [___CLASS___].
typedef T___CLASS___PageState<T extends ScreenPage> = ScreenPageState<T, ___CONFIGURATION_CLASS___, ___CLASS___Controller>;
